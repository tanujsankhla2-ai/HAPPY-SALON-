/**
 * Happy Happy — AI Chatbot Widget — js/chatbot.js
 * ---------------------------------------------
...
(() => {
    ...
    const SYSTEM_PROMPT = `You are "Happy Concierge", a warm and professional AI beauty assistant for Happy — Mumbai's premier luxury hair salon.
...
1. **Expert Hair Styling** — Precision cuts & luxury colour by senior Happy stylists
2. **Hair Spa** — Deep conditioning and scalp treatments with Happy's nourishing protocols
...
- **Modern Signature** — ?349+ (Expert Styling, Deep Conditioning, Full Artistry, Happy Gift) ? Most popular
...
For unrelated questions, politely redirect: "As the Happy Concierge, I'm best equipped to assist with hair, beauty, and our Mumbai salon services."`
    ...
    function buildWidget() {
        ...
        wrapper.setAttribute('aria-label', 'Happy AI Chat Concierge');
        ...
        wrapper.innerHTML = `
            ...
            <button
                ...
                title="Chat with Happy Concierge"
            >
            ...
            >
                ...
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        <div class="chat-header-name">Happy Concierge</div>
                ...
                <div class="chat-input-area">
                    <div class="chat-input-row">
                        <textarea
                            id="mrko-chat-input"
                            placeholder="Ask Happy Concierge anything…"
                            rows="1"
                            maxlength="500"
                    ...
                    <p class="chat-footer-note" aria-hidden="true">? Powered by Happy AI &bull; Gemini 2.0 Flash</p>
                </div>
            </div>
        `;
    ...
    function showTyping() {
        ...
        div.setAttribute('aria-label', 'Happy Concierge is typing');
        div.innerHTML = `
            <div class="msg-avatar bot-avatar" aria-hidden="true"><i class="fas fa-spa"></i></div>
    ...
    async function sendMessage(text) {
        ...
        try {
            ...
            console.error('[Happy Chatbot]', err);
        } finally {
            isTyping = false;
    ...
    function wireEvents() {
        ...
        if (waBtn) {
            waBtn.addEventListener('click', () => {
                window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20Happy!%20I%27d%20like%20to%20inquire%20about%20a%20session.`, '_blank');
            });
        }
