document.addEventListener("DOMContentLoaded", () => {
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', (e) => {
            ...
            const message = `Hello Happy! I'd like to book a session at your Mumbai salon:%0A%0A*Name:* ${name}%0A*Phone:* ${phone}%0A*Service:* ${service}%0A*Date:* ${date}%0A*Time:* ${time}`;
            ...
            if (serviceBanner) serviceBanner.style.display = 'none';
            alert('Redirecting to WhatsApp to book your Happy session!');
        });
    }
