/**
 * Happy Happy - AI Chatbot Backend Proxy Server
...
const SYSTEM_PROMPT = `You are "Happy Concierge", a warm and professional AI assistant for Happy — Mumbai's premier luxury hair salon.
...
1. Information about Happy's services: Expert Hair Styling, Hair Spa, Bridal Makeup
...
4. General hair care tips and beauty advice aligned with Happy's premium philosophy
5. Bridal and special occasion package inquiries

Happy contact / booking: Clients should fill the booking form on the website or WhatsApp at +91 89498 53554. Located in Mumbai.

If asked something completely unrelated to beauty, politely redirect: "As the Happy Concierge, I'm best suited to assist you with hair, beauty, and our Mumbai salon services."
...
// -- Health check --------------------------------------------------
app.get("/health", (_, res) => res.json({ status: "Happy Happy Concierge API is running." }));

// -- Start ---------------------------------------------------------
app.listen(PORT, () => {
  console.log(`\n?  Happy Hair Salon Chatbot Server running at http://localhost:${PORT}`);
